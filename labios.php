...
require("head.php");
?>
<div class="page-heading women-page" id="top">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="inner-content">
                    <h2>Labios</h2>
                    <span>Lusete y deslumbra contus labios.</span>
                </div>
            </div>
        </div>
    </div>
...
<section class="section" id="products">
    ...
    <div class="container">
        <div class="row">
            ...
            if ($conn) {
                $SELECT = "SELECT * FROM productos WHERE categoria = 'labios' ORDER BY rand() LIMIT 3";
