            ...
            <div class="row justify-content-between ">
                <div class="col-lg-6">
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        if ($conn) {
                            // = $id_articulo
                            $SELECT = "SELECT * FROM configuracion  where id_registro = $Iduser  AND predeterminada = 1";
                                ...
                                <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" id="form_pay">
                                    ...
                                    ?>
                                            ...
                                            ?>
                                                <br>
                                                <br>
                                                <button type="button" style="width: 100%;" data-toggle="modal" data-target="#exampleModal" class="btn btn-light">Add new addreess</button>
                                    <?php
                                            }
                                        } else {
                                        }
