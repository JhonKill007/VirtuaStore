                            ...
                            if ($conn) {
                                ...
                                if ($resultadoCO) {
                                    ...
                                    ?>
                                        ...
                                        <button style="border-radius: 5px;" type="button" data-toggle="modal" data-target="#exampleModal" class="btn ">Change</button>
                        ...
                        <div style="text-align: center;">
                            ...
                            <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" id="form_pay">
                                ...
                                ?>
                                    ...
                                    if ($conn) {
                                        $addressC = $_COOKIE['address'];
                                        $SELECT = " SELECT * FROM configuracion where id_registro = '$addressC' LIMIT 1";
                                        $resultadoCO = mysqli_query($conn, $SELECT);
